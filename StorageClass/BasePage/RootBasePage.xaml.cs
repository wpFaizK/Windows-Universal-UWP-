...
namespace BasePage
{
    ...
    /// </summary>
    public partial class RootBasePage : BasePage
    {
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    Label = "Basic Page",
                    DestPage = typeof(BlankPage1)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Edit,
                    Label = "CommandBar Page",
                    DestPage = typeof(BlankPage2)
                },

            });

        public static RootBasePage Current = null;
        ...
        public void HideTogglePaneButton()
        {
            this.TogglePaneButton.Visibility = Visibility.Collapsed;
        }

        public void ShowTogglePaneButton()
        {
        ...
        /// </summary>
        public event TypedEventHandler<RootBasePage, Rect> TogglePaneButtonRectChanged;
